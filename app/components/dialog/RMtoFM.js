...
export default function RMtoFM({ dialogstatus, setDialogstatus, onPress }) {
        ...
        <View style={styles.viewWrapper}>
          <View style={styles.modalView}>
            ...
            <View style={{ justifyContent: "center" }}>
              ...
              >
                Are you ok to skip next level approval, as it is routed for
                FH/RM approval
              </Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  pressable2: {
    ...
    paddingVertical: 14,
    paddingHorizontal: 10,
    // backgroundColor: CustomColors.primary_gray,
