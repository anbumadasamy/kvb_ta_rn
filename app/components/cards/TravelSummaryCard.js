...
export default function TravelSummaryCard({ data, scroll, from, travelCancelRequest }) {
  ...
  function renderItem({ ...itemData }) {
    if (itemData.item.cabStatusId == 3) {
      //booked
    } else if (itemData.item.cabStatusId == 7) {
      // canceled
    } else if (itemData.item.cabStatusId == 0) {
      // not booked
    } else if (itemData.item.cabStatusId == -2) {
      // In progress
    }
        ...
        <View style={styles.row}>
          ...
          {/*  <View style={{ flexDirection: "row" }}>
            <View style={styles.indidatorContainer}>
              <Text style={styles.indidatorText}>A</Text>
            </View>
            <View
              style={styles.indidatorContainer}
            >
              <Text style={styles.indidatorText}>C</Text>
            </View>
            <View style={styles.indidatorContainer}>
              <Text style={styles.indidatorText}>B</Text>
            </View>
            <View style={styles.indidatorContainer}>
              <Text style={styles.indidatorText}>T</Text>
            </View>
            <View style={styles.indidatorContainer}>
              <Text style={styles.indidatorText}>F</Text>
            </View>
          </View> */}
        </View>
